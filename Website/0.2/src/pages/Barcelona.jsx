...
console.log("Districts loaded:", districts);
  ...
  useEffect(() => {
    ...
    Papa.parse(
      "https://raw.githubusercontent.com/com-480-data-visualization/eurobnb-insights/master/Dataset/Processed-Dataset/barcelona_weekends.csv",
      {
        download: true,
        header: true,
  ...
  return (
    <div className={`barcelona-dashboard-page ${dayType}-theme`}>
      <div
        style={{
          position: "sticky",
          top: 0,
      ...
      {/* ====== FILTERS ABOVE MAP ====== */}
      <div
        className="barcelona-filters-row"
        style={{
          marginBottom: "2rem",
          background: "var(--header-bg)",
          padding: "2rem 2.5rem",
      ...
      <div
        className="barcelona-key-insights"
        style={{
          background: "var(--header-bg)",
          borderRadius: "14px",
          boxShadow: "0 2px 12px rgba(0,0,0,0.06)",
      ...
      <div
        className="barcelona-visuals-row"
        style={{
          display: "flex",
          gap: "2rem",
          flexWrap: "wrap",
