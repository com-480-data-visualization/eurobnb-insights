...
console.log("Districts loaded:", districts);
  ...
  useEffect(() => {
    Papa.parse(
      "https://raw.githubusercontent.com/com-480-data-visualization/eurobnb-insights/master/Dataset/Processed-Dataset/berlin_weekdays.csv",
      {
        download: true,
        header: true,
    ...
    Papa.parse(
      "https://raw.githubusercontent.com/com-480-data-visualization/eurobnb-insights/master/Dataset/Processed-Dataset/berlin_weekends.csv",
      {
        download: true,
        header: true,
  ...
  return (
    <div className={`berlin-dashboard-page ${dayType}-theme`}>
      <div
        style={{
          position: "sticky",
          top: 0,
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "2rem" }}>
          <div style={{ fontSize: "3.5rem", lineHeight: 1 }}>
            <span role="img" aria-label="berlin">
                🏙️
            </span>
          </div>
          <div>
