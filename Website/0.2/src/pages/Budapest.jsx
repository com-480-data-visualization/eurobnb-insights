...
console.log("Districts loaded:", districts);
  ...
  useEffect(() => {
    Papa.parse(
      "https://raw.githubusercontent.com/com-480-data-visualization/eurobnb-insights/master/Dataset/Processed-Dataset/budapest_weekdays.csv",
      {
        download: true,
        header: true,
    ...
    Papa.parse(
      "https://raw.githubusercontent.com/com-480-data-visualization/eurobnb-insights/master/Dataset/Processed-Dataset/budapest_weekends.csv",
      {
        download: true,
        header: true,
  ...
  return (
    <div className={`budapest-dashboard-page ${dayType}-theme`}>
      <div
        style={{
          position: "sticky",
          top: 0,
      ...
      {/* ====== FILTERS ABOVE MAP ====== */}
      <div
        className="budapest-filters-row"
        style={{
          marginBottom: "2rem",
          background: "var(--header-bg)",
          padding: "2rem 2.5rem",
      ...
      <div
        className="budapest-key-insights"
        style={{
          background: "var(--header-bg)",
          borderRadius: "14px",
          boxShadow: "0 2px 12px rgba(0,0,0,0.06)",
      ...
      <div
        className="budapest-visuals-row"
        style={{
          display: "flex",
          gap: "2rem",
          flexWrap: "wrap",
