...
const Lisbon = () => {
  ...
  useEffect(() => {
    Papa.parse(
      "https://raw.githubusercontent.com/com-480-data-visualization/eurobnb-insights/master/Dataset/Reduced-Dataset/lisbon_weekdays.csv",
      {
        download: true,
        header: true,
    ...
    Papa.parse(
      "https://raw.githubusercontent.com/com-480-data-visualization/eurobnb-insights/master/Dataset/Reduced-Dataset/lisbon_weekends.csv",
      {
        download: true,
        header: true,
