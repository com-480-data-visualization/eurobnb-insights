...
var withAnimated = (Component2, host3) => {
  const hasInstance = (
  ...
  advance(dt2) {
    ...
    anim.values.forEach((node2, i5) => {
      ...
      if (!finished) {
        ...
        const v0 = node2.v0 != null ? node2.v0 : node2.v0 = is.arr(config22.velocity) ? config22.velocity[i5] : config22.velocity;
        let velocity;
        ...
        if (!is.und(config22.duration)) {
          ...
          if (config22.duration > 0) {
            ...
            p4 = (config22.progress || 0) + elapsed / this._memoizedDuration;
            p4 = p4 > 1 ? 1 : p4 < 0 ? 0 : p4;
            node2.durationProgress = p4;
          }
          position = from + config22.easing(p4) * (to22 - from);
...
function useTransition(data, props, deps) {
  ...
  each(transitions, (t6, i5) => {
    ...
    if (!to22.config) {
      ...
      to22.config = callProp(config22, t6.item, i5, phase);
    }
    delay += trail;
    const payload = {
      ...defaultProps,
...
function u() {
  return u = Object.assign ? Object.assign.bind() : function(t6) {
    for (var e7 = 1; e7 < arguments.length; e7++) {
      var o5 = arguments[e7];
      for (var i5 in o5) ({}).hasOwnProperty.call(o5, i5) && (t6[i5] = o5[i5]);
    }
    return t6;
...
function d(t6, e7) {
  if (null == t6) return {};
  var o5 = {};
  for (var i5 in t6) if ({}.hasOwnProperty.call(t6, i5)) {
...
var M = function() {
  ...
  if (null === t6) throw new Error("Unable to find the theme, did you forget to wrap your component with ThemeProvider?");
  return t6;
};
...
// node_modules/@nivo/core/node_modules/@react-spring/rafz/dist/react-spring_rafz.modern.mjs
...
raf2.setTimeout = (handler, ms) => {
  ...
  const cancel = () => {
    const i5 = timeouts2.findIndex((t6) => t6.cancel == cancel);
    if (~i5) timeouts2.splice(i5, 1);
    pendingCount2 -= ~i5 ? 1 : 0;
  };
  const timeout = { time, handler, cancel };
...
var findTimeout2 = (time) => ~(~timeouts2.findIndex((t6) => t6.time > time) || ~timeouts2.length);
raf2.cancel = (fn2) => {
...
function update3() {
  ...
  if (count) {
    eachSafely2(timeouts2.splice(0, count), (t6) => t6.handler());
    pendingCount2 -= count;
  }
  if (!pendingCount2) {
    stop2();
...
// node_modules/@nivo/core/node_modules/@react-spring/shared/dist/react-spring_shared.modern.mjs
...
function isEqual2(a5, b5) {
  if (is2.arr(a5)) {
    if (!is2.arr(b5) || a5.length !== b5.length) return false;
    for (let i5 = 0; i5 < a5.length; i5++) {
...
function eachProp2(obj, fn2, ctx2) {
  if (is2.arr(obj)) {
    for (let i5 = 0; i5 < obj.length; i5++) {
      fn2.call(ctx2, obj[i5], `${i5}`);
    }
...
var toArray2 = (a5) => is2.und(a5) ? [] : is2.arr(a5) ? a5 : [a5];
...
function advance2(dt2) {
  const nextFrame = prevFrame2;
  for (let i5 = 0; i5 < currentFrame2.length; i5++) {
    const animation = currentFrame2[i5];
...
function hue2rgb2(p4, q, t6) {
  if (t6 < 0) t6 += 1;
  if (t6 > 1) t6 -= 1;
  if (t6 < 1 / 6) return p4 + (q - p4) * 6 * t6;
  if (t6 < 1 / 2) return q;
  if (t6 < 2 / 3) return p4 + (q - p4) * (2 / 3 - t6) * 6;
  return p4;
}
function hslToRgb2(h2, s5, l5) {
  const q = l5 < 0.5 ? l5 * (1 + s5) : l5 + s5 - l5 * s5;
  const p4 = 2 * l5 - q;
  const r5 = hue2rgb2(p4, q, h2 + 1 / 3);
  const g2 = hue2rgb2(p4, q, h2);
  const b5 = hue2rgb2(p4, q, h2 - 1 / 3);
  return Math.round(r5 * 255) << 24 | Math.round(g2 * 255) << 16 | Math.round(b5 * 255) << 8;
}
...
var rgbaRound2 = (_2, p1, p22, p32, p4) => `rgba(${Math.round(p1)}, ${Math.round(p22)}, ${Math.round(p32)}, ${p4})`;
...
// node_modules/@nivo/core/node_modules/@react-spring/core/dist/react-spring_core.modern.mjs
var import_react25 = __toESM(require_react(), 1);

// node_modules/@nivo/core/node_modules/@react-spring/animated/dist/react-spring_animated.modern.mjs
...
var withAnimated2 = (Component2, host3) => {
  const hasInstance = (
    // Function components must use "forwardRef" to avoid being
    // re-rendered on every animation frame.
    !is2.fun(Component2) || Component2.prototype && Component2.prototype.isReactComponent
  );
...
var SpringValue2 = class extends FrameValue2 {
  ...
  advance(dt2) {
    ...
    anim.values.forEach((node2, i5) => {
      ...
      const to22 = (
        // Animated strings always go from 0 to 1.
        node2.constructor == AnimatedString2 ? 1 : payload ? payload[i5].lastPosition : toValues[i5]
      );
      let finished = anim.immediate;
      let position = to22;
      if (!finished) {
        ...
        let elapsed = node2.elapsedTime += dt2;
        const from = anim.fromValues[i5];
        const v0 = node2.v0 != null ? node2.v0 : node2.v0 = is2.arr(config22.velocity) ? config22.velocity[i5] : config22.velocity;
        let velocity;
        const precision = config22.precision || (from == to22 ? 5e-3 : Math.min(1, Math.abs(to22 - from) * 1e-3));
...
var SpringRef2 = () => {
  ...
  SpringRef22.set = function(values) {
    each2(current, (ctrl, i5) => {
      const update22 = is2.fun(values) ? values(i5, ctrl) : values;
      if (update22) {
        ctrl.set(update22);
      }
    });
  ...
  SpringRef22.update = function(props) {
    each2(current, (ctrl, i5) => ctrl.update(this._getProps(props, ctrl, i5)));
    return this;
  };
  const _getProps = function(arg, ctrl, index) {
...
function useSprings2(length, props, deps) {
  ...
  function declareUpdates(startIndex, endIndex) {
    for (let i5 = startIndex; i5 < endIndex; i5++) {
      ...
      const update22 = propsFn ? propsFn(i5, ctrl) : props[i5];
      if (update22) {
        updates.current[i5] = declareUpdate2(update22);
      }
    }
  }
  const springs = ctrls.current.map(
    (ctrl, i5) => getSprings2(ctrl, updates.current[i5])
  );
...
var AutoSizer = class extends import_react30.Component {
  constructor(...args) {
    super(...args);
    this.state = {
  ...
  render() {
    ...
    return (0, import_react30.createElement)(tagName, {
      ref: this._setRef,
      style: {
        ...outerStyle,
        ...style
...
function c(e7, u5, c10) {
  var i5 = this, a5 = (0, import_react31.useRef)(null), o5 = (0, import_react31.useRef)(0), f2 = (0, import_react31.useRef)(null), l5 = (0, import_react31.useRef)([]), v3 = (0, import_react31.useRef)(), m3 = (0, import_react31.useRef)(), d5 = (0, import_react31.useRef)(e7), g2 = (0, import_react31.useRef)(true);
  d5.current = e7;
  var p4 = "undefined" != typeof window, w3 = !u5 && 0 !== u5 && p4;
  if ("function" != typeof e7) throw new TypeError("Expected a function");
  u5 = +u5 || 0;
  var s5 = !!(c10 = c10 || {}).leading, x2 = !("trailing" in c10) || !!c10.trailing, h2 = "maxWait" in c10, y4 = "debounceOnServer" in c10 && !!c10.debounceOnServer, F2 = h2 ? Math.max(+c10.maxWait || 0, u5) : null;
  (0, import_react31.useEffect)(function() {
    return g2.current = true, function() {
      g2.current = false;
    };
  }, []);
  var A3 = (0, import_react31.useMemo)(function() {
    var r5 = function(r6) {
      var n7 = l5.current, t7 = v3.current;
      return l5.current = v3.current = null, o5.current = r6, m3.current = d5.current.apply(t7, n7);
    }, n6 = function(r6, n7) {
      w3 && cancelAnimationFrame(f2.current), f2.current = w3 ? requestAnimationFrame(r6) : setTimeout(r6, n7);
    }, t6 = function(r6) {
      if (!g2.current) return false;
      var n7 = r6 - a5.current;
      return !a5.current || n7 >= u5 || n7 < 0 || h2 && r6 - o5.current >= F2;
    }, e8 = function(n7) {
      return f2.current = null, x2 && l5.current ? r5(n7) : (l5.current = v3.current = null, m3.current);
    }, c11 = function r6() {
      var c13 = Date.now();
      if (t6(c13)) return e8(c13);
      if (g2.current) {
        var i6 = u5 - (c13 - a5.current), f3 = h2 ? Math.min(i6, F2 - (c13 - o5.current)) : i6;
        n6(r6, f3);
      }
    }, A4 = function() {
      if (p4 || y4) {
        var e9 = Date.now(), d6 = t6(e9);
        if (l5.current = [].slice.call(arguments), v3.current = i5, a5.current = e9, d6) {
          if (!f2.current && g2.current) return o5.current = a5.current, n6(c11, u5), s5 ? r5(a5.current) : m3.current;
          if (h2) return n6(c11, u5), r5(a5.current);
        }
        return f2.current || n6(c11, u5), m3.current;
      }
    };
    return A4.cancel = function() {
      f2.current && (w3 ? cancelAnimationFrame(f2.current) : clearTimeout(f2.current)), o5.current = 0, l5.current = a5.current = v3.current = f2.current = null;
    }, A4.isPending = function() {
      return !!f2.current;
    }, A4.flush = function() {
      return f2.current ? e8(Date.now()) : m3.current;
    }, A4;
  }, [s5, h2, u5, F2, x2, w3, p4, y4]);
  return A3;
}
function i2(r5, n6) {
  return r5 === n6;
...
function a(n6, t6, a5) {
  var o5 = a5 && a5.equalityFn || i2, f2 = (0, import_react31.useRef)(n6), l5 = (0, import_react31.useState)({})[1], v3 = c((0, import_react31.useCallback)(function(r5) {
    f2.current = r5, l5({});
  }, [l5]), t6, a5), m3 = (0, import_react31.useRef)(n6);
...
function colors_default(specifier) {
  var n6 = specifier.length / 6 | 0, colors4 = new Array(n6), i5 = 0;
  while (i5 < n6) colors4[i5] = "#" + specifier.slice(i5 * 6, ++i5 * 6);
  return colors4;
}
...
function sinebow_default(t6) {
  var x2;
  t6 = (0.5 - t6) * Math.PI;
  c7.r = 255 * (x2 = Math.sin(t6)) * x2;
  c7.g = 255 * (x2 = Math.sin(t6 + pi_1_3)) * x2;
  c7.b = 255 * (x2 = Math.sin(t6 + pi_2_3)) * x2;
  return c7 + "";
}
...
var Sr = (0, import_react32.createContext)();
var qr = function(e7) {
  var t6 = e7.children, n6 = e7.animate, o5 = void 0 === n6 || n6, i5 = e7.config, a5 = void 0 === i5 ? "default" : i5, l5 = (0, import_react32.useMemo)(function() {
    var e8 = (0, import_isString.default)(a5) ? config2[a5] : a5;
    return { animate: o5, config: e8 };
  }, [o5, a5]);
  return (0, import_jsx_runtime2.jsx)(Sr.Provider, { value: l5, children: t6 });
};
var Dr = function() {
  return (0, import_react32.useContext)(Sr);
};
var Er = function(e7) {
  var r5 = e7.children, t6 = e7.condition, o5 = e7.wrapper;
  return t6 ? (0, import_react32.cloneElement)(o5, {}, r5) : r5;
};
var Ur = { position: "relative" };
var Fr = function(e7) {
  var r5 = e7.children, t6 = e7.theme, n6 = e7.renderWrapper, i5 = void 0 === n6 || n6, a5 = e7.isInteractive, l5 = void 0 === a5 || a5, d5 = e7.animate, u5 = e7.motionConfig, c10 = (0, import_react32.useRef)(null);
...
function Jr(e7, r5) {
  ...
  for (var t6 = 0, n6 = Array(r5); t6 < r5; t6++) n6[t6] = e7[t6];
  return n6;
}
function Qr(e7, r5) {
  var t6 = "undefined" != typeof Symbol && e7[Symbol.iterator] || e7["@@iterator"];
  if (t6) return (t6 = t6.call(e7)).next.bind(t6);
...
function Vr() {
  return Vr = Object.assign ? Object.assign.bind() : function(e7) {
    for (var r5 = 1; r5 < arguments.length; r5++) {
      var t6 = arguments[r5];
      for (var n6 in t6) ({}).hasOwnProperty.call(t6, n6) && (e7[n6] = t6[n6]);
    }
    return e7;
...
var at = (0, import_react32.memo)(function(e7) {
  var r5 = e7.id, t6 = e7.background, n6 = void 0 === t6 ? it.background : t6, o5 = e7.color, i5 = void 0 === o5 ? it.color : o5, a5 = e7.size, l5 = void 0 === a5 ? it.size : a5, d5 = e7.padding, u5 = void 0 === d5 ? it.padding : d5, c10 = e7.stagger, s5 = void 0 === c10 ? it.stagger : c10, f2 = l5 + u5, h2 = l5 / 2, p4 = u5 / 2;
...
var vt = (0, import_react32.memo)(function(e7) {
  var r5 = e7.id, t6 = e7.spacing, n6 = void 0 === t6 ? mt.spacing : t6, o5 = e7.rotation, i5 = void 0 === o5 ? mt.rotation : o5, a5 = e7.background, l5 = void 0 === a5 ? mt.background : a5, d5 = e7.color, u5 = void 0 === d5 ? mt.color : d5, c10 = e7.lineWidth, s5 = void 0 === c10 ? mt.lineWidth : c10, f2 = Math.round(i5) % 360, h2 = Math.abs(n6);
...
var wt = (0, import_react32.memo)(function(e7) {
  var r5 = e7.id, t6 = e7.color, n6 = void 0 === t6 ? _t.color : t6, o5 = e7.background, i5 = void 0 === o5 ? _t.background : o5, a5 = e7.size, l5 = void 0 === a5 ? _t.size : a5, d5 = e7.padding, u5 = void 0 === d5 ? _t.padding : d5, c10 = e7.stagger, s5 = void 0 === c10 ? _t.stagger : c10, f2 = l5 + u5, h2 = u5 / 2;
...
var Ot = ["type"];
var zt = Vr({}, ot, xt);
var Mt = (0, import_react32.memo)(function(e7) {
  var r5 = e7.defs;
  return !r5 || r5.length < 1 ? null : (0, import_jsx_runtime2.jsx)("defs", { "aria-hidden": true, children: r5.map(function(e8) {
    ...
    return zt[r6] ? (0, import_react32.createElement)(zt[r6], Vr({ key: t6.id }, t6)) : null;
  }) });
});
var Rt = (0, import_react32.forwardRef)(function(e7, r5) {
  var t6 = e7.width, n6 = e7.height, o5 = e7.margin, i5 = e7.defs, a5 = e7.children, l5 = e7.role, d5 = e7.ariaLabel, u5 = e7.ariaLabelledBy, c10 = e7.ariaDescribedBy, s5 = e7.isFocusable, f2 = M();
  return (0, import_jsx_runtime2.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: t6, height: n6, role: l5, "aria-label": d5, "aria-labelledby": u5, "aria-describedby": c10, focusable: s5, tabIndex: s5 ? 0 : void 0, ref: r5, children: [(0, import_jsx_runtime2.jsx)(Mt, { defs: i5 }), (0, import_jsx_runtime2.jsx)("rect", { width: t6, height: n6, fill: f2.background }), (0, import_jsx_runtime2.jsx)("g", { transform: "translate(" + o5.left + "," + o5.top + ")", children: a5 })] });
});
var jt = (0, import_react32.memo)(function(e7) {
...
var Ct = (0, import_react32.memo)(function(e7) {
  var r5 = e7.x, t6 = e7.y, n6 = e7.symbol, o5 = void 0 === n6 ? jt : n6, a5 = e7.size, l5 = e7.datum, u5 = e7.color, c10 = e7.borderWidth, s5 = e7.borderColor, f2 = e7.label, h2 = e7.labelTextAnchor, p4 = void 0 === h2 ? "middle" : h2, g2 = e7.labelYOffset, b5 = void 0 === g2 ? -12 : g2, m3 = e7.ariaLabel, _2 = e7.ariaLabelledBy, w3 = e7.ariaDescribedBy, O4 = e7.ariaHidden, R3 = e7.ariaDisabled, j4 = e7.isFocusable, C4 = void 0 !== j4 && j4, B2 = e7.tabIndex, P3 = void 0 === B2 ? 0 : B2, W3 = e7.onFocus, G = e7.onBlur, I = e7.testId, A3 = M(), L3 = Dr(), S3 = L3.animate, Y = L3.config, q = useSpring2({ transform: "translate(" + r5 + ", " + t6 + ")", config: Y, immediate: !S3 }), D = (0, import_react32.useCallback)(function(e8) {
    null == W3 || W3(l5, e8);
  }, [W3, l5]), E3 = (0, import_react32.useCallback)(function(e8) {
    null == G || G(l5, e8);
  }, [G, l5]);
  return (0, import_jsx_runtime2.jsxs)(animated2.g, { transform: q.transform, style: { pointerEvents: "none" }, focusable: C4, tabIndex: C4 ? P3 : void 0, "aria-label": m3, "aria-labelledby": _2, "aria-describedby": w3, "aria-disabled": R3, "aria-hidden": O4, onFocus: C4 && W3 ? D : void 0, onBlur: C4 && G ? E3 : void 0, "data-testid": I, children: [(0, import_react32.createElement)(o5, { size: a5, color: u5, datum: l5, borderWidth: c10, borderColor: s5 }), f2 && (0, import_jsx_runtime2.jsx)("text", { textAnchor: p4, y: b5, style: b(A3.dots.text), children: f2 })] });
});
var Bt = (0, import_react32.memo)(function(e7) {
  var r5 = e7.width, t6 = e7.height, n6 = e7.axis, o5 = e7.scale, i5 = e7.value, a5 = e7.lineStyle, l5 = e7.textStyle, d5 = e7.legend, u5 = e7.legendNode, c10 = e7.legendPosition, s5 = void 0 === c10 ? "top-right" : c10, f2 = e7.legendOffsetX, h2 = void 0 === f2 ? 14 : f2, p4 = e7.legendOffsetY, g2 = void 0 === p4 ? 14 : p4, b5 = e7.legendOrientation, m3 = void 0 === b5 ? "horizontal" : b5, y4 = M(), _2 = 0, w3 = 0, k3 = 0, x2 = 0;
  if ("y" === n6 ? (k3 = o5(i5), w3 = r5) : (_2 = o5(i5), x2 = t6), d5 && !u5) {
    var O4 = function(e8) {
      var r6 = e8.axis, t7 = e8.width, n7 = e8.height, o6 = e8.position, i6 = e8.offsetX, a6 = e8.offsetY, l6 = e8.orientation, d6 = 0, u6 = 0, c11 = "vertical" === l6 ? -90 : 0, s6 = "start";
      if ("x" === r6) switch (o6) {
        case "top-left":
          d6 = -i6, u6 = a6, s6 = "end";
          break;
      ...
      return { x: d6, y: u6, rotation: c11, textAnchor: s6 };
...
var Pt = (0, import_react32.memo)(function(e7) {
...
var It = function(e7) {
  var t6 = Dr(), n6 = t6.animate, i5 = t6.config, l5 = function(e8) {
    var r5 = (0, import_react32.useRef)();
    return (0, import_react32.useEffect)(function() {
      r5.current = e8;
    }, [e8]), r5.current;
  }(e7), d5 = (0, import_react32.useMemo)(function() {
    return string_default(l5, e7);
  }, [l5, e7]), u5 = useSpring2({ from: { value: 0 }, to: { value: 1 }, reset: true, config: i5, immediate: !n6 }).value;
  return to4(u5, d5);
};
var At = (0, import_react32.createContext)(void 0);
...
var Et = function(e7) {
  if (!Lt[e7]) throw new TypeError("'" + e7 + "', is not a valid curve interpolator identifier.");
  return Lt[e7];
};
...
var cn = function(e7, t6, n6) {
  return void 0 === n6 && (n6 = {}), (0, import_react32.useMemo)(function() {
    var r5 = Vr({}, un, n6);
    return { margin: r5, innerWidth: e7 - r5.left - r5.right, innerHeight: t6 - r5.top - r5.bottom, outerWidth: e7, outerHeight: t6 };
  }, [e7, t6, n6]);
};
var sn = function() {
  var e7 = (0, import_react32.useRef)(null), r5 = (0, import_react32.useState)({ left: 0, top: 0, width: 0, height: 0 }), t6 = r5[0], n6 = r5[1], i5 = (0, import_react32.useState)(function() {
...
var Mn = function(e7, r5, t6, n6) {
  var o5 = void 0 === n6 ? {} : n6, i5 = o5.dataKey, a5 = o5.colorKey, l5 = void 0 === a5 ? "color" : a5, d5 = o5.targetKey, u5 = void 0 === d5 ? "fill" : d5, c10 = [], s5 = {};
  return e7.length && r5.length && (c10 = [].concat(e7), r5.forEach(function(r6) {
      ...
      if (zn(a7, r6, i5)) {
        ...
        if (d6) {
          if (On.includes(d6.type)) if ("inherit" === d6.background || "inherit" === d6.color) {
            ...
            "inherit" === d6.background && (g2 = g2 + ".bg." + f2, h2 = f2), "inherit" === d6.color && (g2 = g2 + ".fg." + f2, p4 = f2), (0, import_set2.default)(r6, u5, "url(#" + g2 + ")"), s5[g2] || (c10.push(Vr({}, d6, { id: g2, background: h2, color: p4 })), s5[g2] = 1);
            ...
            if (d6.colors.map(function(e8) {
              ...
              v3.id = m3, (0, import_set2.default)(r6, u5, "url(#" + m3 + ")"), s5[m3] || (c10.push(v3), s5[m3] = 1);
            } else (0, import_set2.default)(r6, u5, "url(#" + o7 + ")");
          }
        }
        return 1;
...
function Rn() {
  for (var e7 = arguments.length, r5 = new Array(e7), t6 = 0; t6 < e7; t6++) r5[t6] = arguments[t6];
  return function(e8) {
...
function v() {
  return v = Object.assign ? Object.assign.bind() : function(t6) {
    for (var i5 = 1; i5 < arguments.length; i5++) {
      var n6 = arguments[i5];
      for (var o5 in n6) ({}).hasOwnProperty.call(n6, o5) && (t6[o5] = n6[o5]);
    }
    return t6;
...
var g = (0, import_react33.memo)(function(t6) {
  var n6, o5 = t6.position, r5 = t6.anchor, e7 = t6.children, l5 = M(), u5 = Dr(), y4 = u5.animate, f2 = u5.config, g2 = sn(), w3 = g2[0], T2 = g2[1], C4 = (0, import_react33.useRef)(false), E3 = void 0, P3 = false, V2 = T2.width > 0 && T2.height > 0, O4 = Math.round(o5[0]), N2 = Math.round(o5[1]);
  ...
  var z5 = function(t7, i5) {
    if (null == t7) return {};
    var n7 = {};
    for (var o6 in t7) if ({}.hasOwnProperty.call(t7, o6)) {
...
var w2 = (0, import_react33.memo)(function(t6) {
...
var T = (0, import_react33.memo)(function(t6) {
  var i5, n6 = t6.id, o5 = t6.value, r5 = t6.format, e7 = t6.enableChip, l5 = void 0 !== e7 && e7, a5 = t6.color, c10 = t6.renderContent, s5 = M(), h2 = hn(r5);
...
var E = (0, import_react33.memo)(function(t6) {
...
var P2 = (0, import_react33.memo)(function(t6) {
  var i5 = t6.x0, o5 = t6.x1, r5 = t6.y0, e7 = t6.y1, l5 = M(), h2 = Dr(), u5 = h2.animate, y4 = h2.config, f2 = (0, import_react33.useMemo)(function() {
...
var V = (0, import_react33.memo)(function(t6) {
...
var O2 = (0, import_react33.createContext)({ showTooltipAt: function() {
}, showTooltipFromEvent: function() {
}, hideTooltip: function() {
} });
var N = { isVisible: false, position: [null, null], content: null, anchor: null };
var j2 = (0, import_react33.createContext)(N);
var k = function(t6) {
  var i5 = (0, import_react33.useState)(N), o5 = i5[0], l5 = i5[1], a5 = (0, import_react33.useCallback)(function(t7, i6, n6) {
    var o6 = i6[0], r5 = i6[1];
    void 0 === n6 && (n6 = "top"), l5({ isVisible: true, position: [o6, r5], anchor: n6, content: t7 });
  }, [l5]), c10 = (0, import_react33.useCallback)(function(i6, n6, o6) {
    void 0 === o6 && (o6 = "top");
    var r5 = t6.current.getBoundingClientRect(), e7 = t6.current.offsetWidth, a6 = e7 === r5.width ? 1 : e7 / r5.width, c11 = "touches" in n6 ? n6.touches[0] : n6, s6 = c11.clientX, h2 = c11.clientY, u5 = (s6 - r5.left) * a6, d5 = (h2 - r5.top) * a6;
    "left" !== o6 && "right" !== o6 || (o6 = u5 < r5.width / 2 ? "right" : "left"), l5({ isVisible: true, position: [u5, d5], anchor: o6, content: i6 });
  }, [t6, l5]), s5 = (0, import_react33.useCallback)(function() {
    l5(N);
  }, [l5]);
  return { actions: (0, import_react33.useMemo)(function() {
    return { showTooltipAt: a5, showTooltipFromEvent: c10, hideTooltip: s5 };
  }, [a5, c10, s5]), state: o5 };
};
var z3 = function() {
  var t6 = (0, import_react33.useContext)(O2);
  if (void 0 === t6) throw new Error("useTooltip must be used within a TooltipProvider");
  return t6;
};
var A = function() {
  var t6 = (0, import_react33.useContext)(j2);
...
function Se(e7, r5) {
  (null == r5 || r5 > e7.length) && (r5 = e7.length);
  for (var n6 = 0, t6 = Array(r5); n6 < r5; n6++) t6[n6] = e7[n6];
  return t6;
}
function qe(e7, r5) {
...
function Ce() {
  return Ce = Object.assign ? Object.assign.bind() : function(e7) {
    for (var r5 = 1; r5 < arguments.length; r5++) {
      var n6 = arguments[r5];
      for (var t6 in n6) ({}).hasOwnProperty.call(n6, t6) && (e7[t6] = n6[t6]);
    }
    return e7;
  ...
  if ((0, import_isPlainObject2.default)(e7)) {
    ...
    if (We(e7)) {
      ...
      if (Array.isArray(e7.modifiers)) {
        ...
        }, l5 = qe(e7.modifiers); !(o5 = l5()).done; ) u5();
  ...
  if ((0, import_isPlainObject2.default)(e7)) {
    ...
    if (function(e8) {
      ...
      if (Je(e7.scheme)) {
        ...
        var c10 = ordinal($e[e7.scheme][e7.size || 9]), s5 = function(e8) {
          return c10(n6(e8));
        };
        return s5.scale = c10, s5;
      }
    }
...
function p2() {
  return p2 = Object.assign ? Object.assign.bind() : function(t6) {
    for (var e7 = 1; e7 < arguments.length; e7++) {
      var o5 = arguments[e7];
      for (var n6 in o5) ({}).hasOwnProperty.call(o5, n6) && (t6[n6] = o5[n6]);
    }
    return t6;
...
function s3(t6, e7) {
  if (null == t6) return {};
  var o5 = {};
  for (var n6 in t6) if ({}.hasOwnProperty.call(t6, n6)) {
...
var b3 = function(r5) {
  var i5 = r5.style, l5 = r5.children, c10 = s3(r5, h), f2 = i5.outlineWidth, u5 = i5.outlineColor, a5 = i5.outlineOpacity, d5 = s3(i5, m2);
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [f2 > 0 && (0, import_jsx_runtime4.jsx)(animated.text, p2({}, c10, { style: p2({}, d5, { strokeWidth: 2 * f2, stroke: u5, strokeOpacity: a5, strokeLinejoin: "round" }), children: l5 })), (0, import_jsx_runtime4.jsx)(animated.text, p2({}, c10, { style: d5, children: l5 }))] });
};
...
var v2 = function(e7) {
  var i5 = e7.x, n6 = e7.y, o5 = e7.size, r5 = e7.fill, l5 = e7.opacity, a5 = void 0 === l5 ? 1 : l5, c10 = e7.borderWidth, s5 = void 0 === c10 ? 0 : c10, d5 = e7.borderColor;
...
function b4() {
  return b4 = Object.assign ? Object.assign.bind() : function(t6) {
    for (var e7 = 1; e7 < arguments.length; e7++) {
      var i5 = arguments[e7];
      for (var n6 in i5) ({}).hasOwnProperty.call(i5, n6) && (t6[n6] = i5[n6]);
    }
    return t6;
...
var A2 = function(t6) {
  ...
  if ("number" != typeof o5 && ("object" != typeof (e7 = o5) || Array.isArray(e7) || null === e7)) throw new Error("Invalid property padding, must be one of: number, object");
  var c10 = "number" == typeof o5 ? { top: o5, right: o5, bottom: o5, left: o5 } : b4({}, S2, o5), s5 = c10.left + c10.right, d5 = c10.top + c10.bottom, h2 = l5 + s5, g2 = a5 + d5, m3 = (r5 - 1) * n6;
  return "row" === i5 ? h2 = l5 * r5 + m3 + s5 : "column" === i5 && (g2 = a5 * r5 + m3 + d5), { width: h2, height: g2, padding: c10 };
};
var C3 = function(t6) {
  var e7 = t6.anchor, i5 = t6.translateX, n6 = t6.translateY, o5 = t6.containerWidth, r5 = t6.containerHeight, l5 = t6.width, a5 = t6.height, c10 = i5, s5 = n6;
  switch (e7) {
    case "top":
      c10 += (o5 - l5) / 2;
      break;
    case "top-right":
      ...
      break;
    case "right":
      c10 += o5 - l5, s5 += (r5 - a5) / 2;
      break;
    case "bottom-right":
      c10 += o5 - l5, s5 += r5 - a5;
      break;
    case "bottom":
      c10 += (o5 - l5) / 2, s5 += r5 - a5;
      break;
    case "bottom-left":
      s5 += r5 - a5;
      break;
    case "left":
      ...
      break;
    case "center":
      c10 += (o5 - l5) / 2, s5 += (r5 - a5) / 2;
  }
  return { x: c10, y: s5 };
};
var z4 = function(t6) {
  var e7, i5, n6, o5, r5, l5, a5 = t6.direction, c10 = t6.justify, s5 = t6.symbolSize, d5 = t6.symbolSpacing, h2 = t6.width, g2 = t6.height;
  switch (a5) {
    case "left-to-right":
      e7 = 0, i5 = (g2 - s5) / 2, o5 = g2 / 2, l5 = "central", c10 ? (n6 = h2, r5 = "end") : (n6 = s5 + d5, r5 = "start");
      break;
    case "right-to-left":
      e7 = h2 - s5, i5 = (g2 - s5) / 2, o5 = g2 / 2, l5 = "central", c10 ? (n6 = 0, r5 = "start") : (n6 = h2 - s5 - d5, r5 = "end");
      break;
    case "top-to-bottom":
      e7 = (h2 - s5) / 2, i5 = 0, n6 = h2 / 2, r5 = "middle", c10 ? (o5 = g2, l5 = "alphabetic") : (o5 = s5 + d5, l5 = "text-before-edge");
      break;
    case "bottom-to-top":
      e7 = (h2 - s5) / 2, i5 = g2 - s5, n6 = h2 / 2, r5 = "middle", c10 ? (o5 = 0, l5 = "text-before-edge") : (o5 = g2 - s5 - d5, l5 = "alphabetic");
  }
...
var B = function(i5) {
  var n6, o5, r5, a5, d5, m3, f2, v3, u5, p4, y4, x2 = i5.x, S3 = i5.y, A3 = i5.width, C4 = i5.height, W3 = i5.data, w3 = i5.direction, X = void 0 === w3 ? k2.itemDirection : w3, Y = i5.justify, B2 = void 0 === Y ? k2.justify : Y, H2 = i5.textColor, E3 = i5.background, j4 = void 0 === E3 ? "transparent" : E3, L3 = i5.opacity, M4 = void 0 === L3 ? 1 : L3, P3 = i5.symbolShape, F2 = void 0 === P3 ? k2.symbolShape : P3, T2 = i5.symbolSize, V2 = void 0 === T2 ? k2.symbolSize : T2, D = i5.symbolSpacing, R3 = void 0 === D ? k2.symbolSpacing : D, q = i5.symbolBorderWidth, G = void 0 === q ? 0 : q, I = i5.symbolBorderColor, _2 = void 0 === I ? "transparent" : I, J = i5.onClick, K = i5.onMouseEnter, N2 = i5.onMouseLeave, Q = i5.toggleSerie, U = i5.effects, Z = (0, import_react35.useState)({}), $ = Z[0], tt2 = Z[1], et = M(), it2 = (0, import_react35.useCallback)(function(t6) {
    ...
    null == K || K(W3, t6);
  }, [K, W3, U]), nt = (0, import_react35.useCallback)(function(t6) {
    if (U) {
      var e7 = U.filter(function(t7) {
        return "hover" !== t7.on;
      }).reduce(function(t7, e8) {
    ...
    null == N2 || N2(W3, t6);
  }, [N2, W3, U]), ot2 = z4({ direction: X, justify: B2, symbolSize: null != (n6 = $.symbolSize) ? n6 : V2, symbolSpacing: R3, width: A3, height: C4 }), rt2 = ot2.symbolX, lt = ot2.symbolY, at2 = ot2.labelX, ct2 = ot2.labelY, st = ot2.labelAnchor, dt2 = ot2.labelAlignment, ht2 = [J, K, N2, Q].some(function(t6) {
    return void 0 !== t6;
...
var L2 = function(t6, e7) {
  var i5 = e7.data, n6 = e7.containerWidth, o5 = e7.containerHeight, r5 = e7.translateX, l5 = void 0 === r5 ? 0 : r5, a5 = e7.translateY, c10 = void 0 === a5 ? 0 : a5, s5 = e7.anchor, d5 = e7.direction, h2 = e7.padding, g2 = void 0 === h2 ? 0 : h2, v3 = e7.justify, u5 = void 0 !== v3 && v3, p4 = e7.itemsSpacing, y4 = void 0 === p4 ? 0 : p4, k3 = e7.itemWidth, x2 = e7.itemHeight, S3 = e7.itemDirection, W3 = void 0 === S3 ? "left-to-right" : S3, w3 = e7.itemTextColor, X = e7.symbolSize, Y = void 0 === X ? 16 : X, O4 = e7.symbolSpacing, B2 = void 0 === O4 ? 8 : O4, H2 = e7.theme, E3 = A2({ itemCount: i5.length, itemWidth: k3, itemHeight: x2, itemsSpacing: y4, direction: d5, padding: g2 }), L3 = E3.width, M4 = E3.height, P3 = E3.padding, F2 = C3({ anchor: s5, translateX: l5, translateY: c10, containerWidth: n6, containerHeight: o5, width: L3, height: M4 }), T2 = F2.x, V2 = F2.y, D = "row" === d5 ? k3 + y4 : 0, R3 = "column" === d5 ? x2 + y4 : 0;
  t6.save(), t6.translate(T2, V2), a3(t6, H2.legends.text), i5.forEach(function(e8, i6) {
    var n7, o6 = i6 * D + P3.left, r6 = i6 * R3 + P3.top, l6 = z4({ direction: W3, justify: u5, symbolSize: Y, symbolSpacing: B2, width: k3, height: x2 }), a6 = l6.symbolX, c11 = l6.symbolY, s6 = l6.labelX, d6 = l6.labelY, h3 = l6.labelAnchor, g3 = l6.labelAlignment;
    t6.fillStyle = null != (n7 = e8.color) ? n7 : "black", t6.fillRect(o6 + a6, r6 + c11, Y, Y), t6.textAlign = j3[h3], "central" === g3 && (t6.textBaseline = "middle"), d3(t6, b4({}, H2.legends.text, { fill: null != w3 ? w3 : H2.legends.text.fill }), String(e8.label), o6 + s6, r6 + d6);
  }), t6.restore();
};
...
//# sourceMappingURL=chunk-Q4H5M6PP.js.map
