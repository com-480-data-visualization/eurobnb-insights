...
// node_modules/@nivo/bar/node_modules/@react-spring/rafz/dist/react-spring_rafz.modern.mjs
...
// node_modules/@nivo/bar/node_modules/@react-spring/shared/dist/react-spring_shared.modern.mjs
...
function isEqual(a3, b2) {
  if (is.arr(a3)) {
    if (!is.arr(b2) || a3.length !== b2.length) return false;
...
// node_modules/@nivo/bar/node_modules/@react-spring/core/dist/react-spring_core.modern.mjs
var import_react10 = __toESM(require_react(), 1);

// node_modules/@nivo/bar/node_modules/@react-spring/animated/dist/react-spring_animated.modern.mjs
...
function useTransition(data, props, deps) {
  ...
  if (is.fun(sort)) {
    transitions.sort((a3, b2) => sort(a3.item, b2.item));
  }
  let delay = -trail;
  const forceUpdate = useForceUpdate();
  ...
  each(transitions, (t2, i2) => {
    ...
    to22 = callProp(to22, t2.item, i2);
    to22 = is.obj(to22) ? inferTo(to22) : { to: to22 };
    if (!to22.config) {
      const config2 = propsConfig || defaultProps.config;
      to22.config = callProp(config2, t2.item, i2, phase);
    }
    delay += trail;
    const payload = {
      ...defaultProps,
  ...
  const renderTransitions = (render) => React22.createElement(React22.Fragment, null, transitions.map((t2, i2) => {
...
var te = ["data"];
var ae = function(i2) {
  var n2, l2 = i2.bar, r2 = l2.data, o3 = U(l2, te), d2 = i2.style, u = d2.borderColor, s = d2.color, c = d2.height, h = d2.labelColor, f = d2.labelOpacity, b2 = d2.labelX, g = d2.labelY, v = d2.transform, m = d2.width, p = d2.textAnchor, y = i2.borderRadius, x = i2.borderWidth, S = i2.label, k = i2.shouldRenderLabel, w = i2.isInteractive, L2 = i2.onClick, M2 = i2.onMouseEnter, B = i2.onMouseLeave, R2 = i2.tooltip, O2 = i2.isFocusable, I = i2.ariaLabel, T3 = i2.ariaLabelledBy, P = i2.ariaDescribedBy, E2 = i2.ariaDisabled, F = i2.ariaHidden, z2 = M(), X = z(), G = X.showTooltipFromEvent, N = X.showTooltipAt, j3 = X.hideTooltip, K = (0, import_react15.useMemo)(function() {
    return function() {
      return (0, import_react15.createElement)(R2, Q({}, o3, r2));
    };
  }, [R2, o3, r2]), _ = (0, import_react15.useCallback)(function(e2) {
    null == L2 || L2(Q({ color: o3.color }, r2), e2);
  }, [o3, r2, L2]), q2 = (0, import_react15.useCallback)(function(e2) {
    return G(K(), e2);
  }, [G, K]), J3 = (0, import_react15.useCallback)(function(e2) {
    null == M2 || M2(r2, e2), G(K(), e2);
  }, [r2, M2, G, K]), Z2 = (0, import_react15.useCallback)(function(e2) {
    null == B || B(r2, e2), j3();
  }, [r2, j3, B]), $2 = (0, import_react15.useCallback)(function() {
    N(K(), [o3.absX + o3.width / 2, o3.absY]);
  }, [N, K, o3]), ee2 = (0, import_react15.useCallback)(function() {
    j3();
  }, [j3]);
  return (0, import_jsx_runtime.jsxs)(animated.g, { transform: v, children: [(0, import_jsx_runtime.jsx)(animated.rect, { width: to2(m, function(e2) {
    return Math.max(e2, 0);
  }), height: to2(c, function(e2) {
    return Math.max(e2, 0);
...
var pe = function(e2, t2, a3, i2) {
  ...
  return c.forEach(function(e3, a4) {
    return ve(0, h.domain().length).forEach(function(u2) {
      var c6, p, y, x = ce(n2[u2][e3]), S = x[0], k = x[1], w = o3(n2[u2]), L2 = (null != (c6 = h(w)) ? c6 : 0) + t2 * a4 + s * a4, C = g(p = k, 0) ? null != (y = f(p)) ? y : 0 : i2, W2 = function(e4, t3) {
        var a5;
...
var Ie = function(t2) {
  ...
  }, [ne2, d2, me2]), Le2 = null != (n2 = A.reverse) && n2, Ie2 = (0, import_react15.useMemo)(function() {
  ...
  }, [$2, we2, me2, C, M2, ee2, Le2]), Ve2 = (0, import_react15.useMemo)(function() {
    return function(e2, t3, a3, i2, n3, l3, r3) {
      ...
      if ("stacked" === n3) {
        ...
        e2.forEach(function(e3) {
          ...
          Me(d3, a4, Number(i3)), Be(c6, a4, Number(i3));
        }), c6.forEach(function(e3, n4) {
          var c7, h3, f2, b2 = d3.get(n4) || 0;
          "vertical" === i2 ? (c7 = t3(n4), h3 = a3(e3), f2 = a3(e3 / 2)) : (c7 = t3(e3), h3 = a3(n4), f2 = t3(e3 / 2)), c7 += "vertical" === i2 ? u2 / 2 : l3, h3 += "vertical" === i2 ? -l3 : s2 / 2, o4.push({ key: "total_" + n4, x: c7, y: h3, value: b2, formattedValue: r3(b2), animationOffset: f2 });
        });
      } else if ("grouped" === n3) {
        ...
        e2.forEach(function(e3) {
          ...
          var c7, h3, b2, g2 = d3.get(n4) || 0, v2 = f.get(n4);
          "vertical" === i2 ? (c7 = t3(n4), h3 = a3(e3), b2 = a3(e3 / 2)) : (c7 = t3(e3), h3 = a3(n4), b2 = t3(e3 / 2)), c7 += "vertical" === i2 ? v2 * u2 / 2 : l3, h3 += "vertical" === i2 ? -l3 : v2 * s2 / 2, o4.push({ key: "total_" + n4, x: c7, y: h3, value: g2, formattedValue: r3(g2), animationOffset: b2 });
        });
      }
      return o4;
...
var He = function(a3) {
  ...
  }, config: $e, immediate: !Ze, initial: Ze ? void 0 : null }), kt = (0, import_react15.useMemo)(function() {
  ...
  return (0, import_jsx_runtime.jsx)(Rt, { width: tt, height: at, margin: it, defs: wt, role: He2, ariaLabel: Pe2, ariaLabelledBy: Ee2, ariaDescribedBy: Fe2, isFocusable: De2, ref: Qe, children: D.map(function(e2, a4) {
    var i3;
    return "function" == typeof e2 ? (0, import_jsx_runtime.jsx)(import_react15.Fragment, { children: (0, import_react15.createElement)(e2, Ct) }, a4) : null != (i3 = null == Lt ? void 0 : Lt[e2]) ? i3 : null;
  }) });
};
var Pe = (0, import_react15.forwardRef)(function(e2, t2) {
...
var ze = function(i2) {
  ...
  var gt = (0, import_react15.useCallback)(function(e2) {
    if (Qe && Xe2.current) {
      var a3 = kn(Xe2.current, e2), i3 = a3[0], n3 = a3[1], l3 = Fe(Qe, Ne, i3, n3);
      void 0 !== l3 ? (ut((0, import_react15.createElement)(We2, Q({}, l3.data, { color: l3.color, label: l3.label, value: Number(l3.data.value) })), e2), "mouseenter" === e2.type && (null == Be2 || Be2(l3.data, e2))) : st();
    }
  }, [st, Ne, Be2, Qe, ut, We2]), vt = (0, import_react15.useCallback)(function(e2) {
    if (Qe && Xe2.current) {
      st();
      var t2 = kn(Xe2.current, e2), a3 = t2[0], i3 = t2[1], n3 = Fe(Qe, Ne, a3, i3);
      n3 && (null == Re2 || Re2(n3.data, e2));
    }
  }, [st, Ne, Re2, Qe]), mt = (0, import_react15.useCallback)(function(e2) {
    if (Qe && Xe2.current) {
      var t2 = kn(Xe2.current, e2), a3 = t2[0], i3 = t2[1], n3 = Fe(Qe, Ne, a3, i3);
...
var De = (0, import_react15.forwardRef)(function(e2, t2) {
...
var Xe = (0, import_react15.forwardRef)(function(e2, t2) {
...
var Ge = (0, import_react15.forwardRef)(function(e2, t2) {
