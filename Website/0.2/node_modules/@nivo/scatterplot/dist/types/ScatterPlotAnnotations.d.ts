...
export declare const ScatterPlotAnnotations: <RawDatum extends ScatterPlotDatum>({ nodes, annotations, }: ScatterPlotAnnotationsProps<RawDatum>) => import("react/jsx-runtime").JSX.Element;
export {};
